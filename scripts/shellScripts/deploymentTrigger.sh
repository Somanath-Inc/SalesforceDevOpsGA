...
then
    ...
    sfdx force:source:deploy --manifest package/package.xml --target-username $USERNAME --postdestructivechanges package/destructiveChanges.xml --wait 0 --json > validation.json
    cat deployment.json
